...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Note: DDL operations (Schema changes) cannot be wrapped in transactions on MariaDB/MySQL
        // as they cause implicit commits. We handle this without a transaction wrapper.
