...
# Skills
- Invoke skill `frontend-app` as required
...
- **[.claude/guides/frontend/app](./.claude/guides/frontend/app)** - **MUST READ**: Complete app dashboard development guide (components, composables, services, testing)