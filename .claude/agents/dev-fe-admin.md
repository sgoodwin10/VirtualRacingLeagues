...
- **[.claude/guides/frontend/admin](./.claude/guides/frontend/admin)** - **MUST READ**: Complete admin dashboard development guide (components, composables, services, testing)
