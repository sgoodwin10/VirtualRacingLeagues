...
argument-hint: The path to the plan to implement
---
...
- Read the original ticket (if mentioned) and all files mentioned in the plan
...
- Run the success criteria checks (usually `.claude/support/scripts/phpunit_run_tests.sh` and `.claude/support/scripts/vitests_run_tests.sh` covers everything)
...
## Agents ##
- Confirm which agent to use for the development
