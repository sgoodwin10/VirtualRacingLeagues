...
describe('LeagueCard', () => {
  const mockLeague: PublicLeague = {
    ...
    header_image: {
      ...
      srcset: '',
      conversions: {
        thumb: 'https://example.com/header-thumb.jpg',
        small: 'https://example.com/header-small.jpg',
        medium: 'https://example.com/header-medium.jpg',
        large: 'https://example.com/header-large.jpg',
      },
    },
    banner_url: null,
    banner: null,
