...
describe('InfoItem', () => {
  ...
  it('renders with icon, title, and text', () => {
    ...
    // Should have space-y-1 class when title exists
  ...
  it('applies correct styling to icon', () => {
    ...
    expect(icon.classes()).toContain('text-slate-500');
  ...
  it('applies correct styling to title when present', () => {
    ...
    const title = wrapper.find('.text-xs.font-medium.uppercase.text-slate-400');
  ...
  it('applies correct styling to text', () => {
    ...
    const text = wrapper.find('.text-slate-700');
