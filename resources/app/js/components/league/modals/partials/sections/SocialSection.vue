...
<template>
  <div class="space-y-4">
    <div class="mb-4">
      <h3 class="text-section-label mb-1">Social Links</h3>
      <p class="text-[var(--text-secondary)] m-0">Connect your community channels</p>
    </div>
    ...
    <SocialMediaFields
      ...
      @update:discord-url="emit('update:discordUrl', $event)"
