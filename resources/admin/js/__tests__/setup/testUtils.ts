/**
 * Test Utilities for Admin Dashboard Tests
 *
 * Provides helper functions and utilities for testing Vue components in the admin dashboard.
 */
...
export function mountWithStubs<T extends ComponentPublicInstance>(
  ...
  // Merge: custom plugins (which may include custom Pinia/Router) + default Pinia/Router (if needed) + PrimeVue plugins
