...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Domain\Admin\Repositories\AdminRepositoryInterface' => \App\Infrastructure\Persistence\Eloquent\Repositories\EloquentAdminRepository::class,
            'App\Domain\Competition\Repositories\CompetitionRepositoryInterface' => \App\Infrastructure\Persistence\Eloquent\Repositories\EloquentCompetitionRepository::class,
            'App\Domain\Competition\Repositories\SeasonDriverRepositoryInterface' => \App\Infrastructure\Persistence\Eloquent\Repositories\EloquentSeasonDriverRepository::class,
            'App\Domain\Competition\Repositories\SeasonRepositoryInterface' => \App\Infrastructure\Persistence\Eloquent\Repositories\EloquentSeasonRepository::class,
            'App\Domain\Driver\Repositories\DriverRepositoryInterface' => \App\Infrastructure\Persistence\Eloquent\Repositories\EloquentDriverRepository::class,
            'App\Domain\League\Repositories\LeagueRepositoryInterface' => \App\Infrastructure\Persistence\Eloquent\Repositories\EloquentLeagueRepository::class,
            'App\Domain\SiteConfig\Repositories\FileStorageServiceInterface' => \App\Infrastructure\Persistence\Eloquent\Repositories\LocalFileStorageService::class,
            'App\Domain\SiteConfig\Repositories\SiteConfigRepositoryInterface' => \App\Infrastructure\Persistence\Eloquent\Repositories\EloquentSiteConfigRepository::class,
    ...
    override(\auth()->user(), map([
        '' => \App\Infrastructure\Persistence\Eloquent\Models\UserEloquent::class,
    ]));
    ...
    override(\config(), map([
            ...
            'admin_permissions.roles.super_admin' => 'array',
            'admin_permissions.roles.admin' => 'array',
            'admin_permissions.roles.moderator' => 'array',
            'admin_permissions.permissions.users.view' => 'string',
            'admin_permissions.permissions.users.create' => 'string',
            'admin_permissions.permissions.users.update' => 'string',
            'admin_permissions.permissions.users.delete' => 'string',
            'admin_permissions.permissions.admins.view' => 'string',
            'admin_permissions.permissions.admins.create' => 'string',
            'admin_permissions.permissions.admins.update' => 'string',
            'admin_permissions.permissions.admins.delete' => 'string',
            'admin_permissions.permissions.leagues.view' => 'string',
            'admin_permissions.permissions.leagues.create' => 'string',
            'admin_permissions.permissions.leagues.update' => 'string',
            'admin_permissions.permissions.leagues.delete' => 'string',
            'admin_permissions.permissions.races.view' => 'string',
            'admin_permissions.permissions.races.create' => 'string',
            'admin_permissions.permissions.races.update' => 'string',
            'admin_permissions.permissions.races.delete' => 'string',
            'admin_permissions.permissions.reports.view' => 'string',
            'admin_permissions.permissions.reports.export' => 'string',
            'admin_permissions.permissions.analytics.view' => 'string',
            'admin_permissions.permissions.settings.view' => 'string',
            'admin_permissions.permissions.settings.update' => 'string',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
            ...
            'services.google_analytics.tracking_id' => 'NULL',
...
'viewTelescope','__construct','toEntity','viewAny','view',
...
'admin_permissions.roles.super_admin','admin_permissions.roles.admin','admin_permissions.roles.moderator','admin_permissions.permissions.users.view','admin_permissions.permissions.users.create',
'admin_permissions.permissions.users.update','admin_permissions.permissions.users.delete','admin_permissions.permissions.admins.view','admin_permissions.permissions.admins.create','admin_permissions.permissions.admins.update',
'admin_permissions.permissions.admins.delete','admin_permissions.permissions.leagues.view','admin_permissions.permissions.leagues.create','admin_permissions.permissions.leagues.update','admin_permissions.permissions.leagues.delete',
'admin_permissions.permissions.races.view','admin_permissions.permissions.races.create','admin_permissions.permissions.races.update','admin_permissions.permissions.races.delete','admin_permissions.permissions.reports.view',
'admin_permissions.permissions.reports.export','admin_permissions.permissions.analytics.view','admin_permissions.permissions.settings.view','admin_permissions.permissions.settings.update','app.name',
...
'services.slack.notifications.channel','services.google_analytics.tracking_id','session.driver','session.lifetime','session.expire_on_close',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','data.date_format','data.date_timezone','data.features.cast_and_transform_iterables','data.features.ignore_exception_when_trying_to_set_computed_property_value',
...
'signed','throttle','verified','admin.authenticate','admin.role',
'user.authenticate',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','telescope','admin.api.','admin.api.login','admin.api.check','admin.api.me',
'admin.api.logout','admin.api.profile','admin.api.profile.update','admin.api.admins.index','admin.api.admins.store',
'admin.api.admins.show','admin.api.admins.update','admin.api.admins.destroy','admin.api.admins.restore','admin.api.activities.index',
'admin.api.activities.admins','admin.api.activities.admin','admin.api.activities.users','admin.api.activities.user','admin.api.activities.show',
'admin.api.activities.clean','admin.api.users.index','admin.api.users.store','admin.api.users.show','admin.api.users.update',
'admin.api.users.destroy','admin.api.users.restore','admin.api.users.verify-email','admin.api.users.resend-verification','admin.api.users.login-as',
'admin.api.site-config.show','admin.api.site-config.update','login-as','api.csrf-cookie',
'api.me','api.impersonate','api.logout','api.verification.resend','api.profile.update',
'api.site-config.show','api.platforms.index','api.timezones.index','api.leagues.index','api.leagues.store',
'api.leagues.show','api.leagues.update','api.leagues.destroy','api.leagues.check-slug','api.leagues.platforms',
'api.leagues.driver-columns','api.leagues.driver-form-fields','api.leagues.driver-csv-headers','api.leagues.drivers.index','api.leagues.drivers.store',
'api.leagues.drivers.show','api.leagues.drivers.update','api.leagues.drivers.destroy','api.leagues.drivers.import-csv','api.leagues.competitions.index',
'api.leagues.competitions.store','api.leagues.competitions.check-slug','api.competitions.show','api.competitions.update','api.competitions.destroy',
'api.competitions.archive','api.competitions.seasons.index','api.competitions.seasons.store','api.competitions.seasons.check-slug','api.seasons.show',
'api.seasons.update','api.seasons.destroy','api.seasons.archive','api.seasons.activate','api.seasons.complete',
'api.seasons.restore','api.seasons.drivers.index','api.seasons.drivers.store','api.seasons.drivers.available','api.seasons.drivers.stats',
'api.seasons.drivers.bulk','api.seasons.drivers.update','api.seasons.drivers.destroy','public.login-as',
'admin.api.','admin.api.login','admin.api.check','admin.api.me','admin.api.logout',
'admin.api.profile','admin.api.profile.update','admin.api.admins.index','admin.api.admins.store','admin.api.admins.show',
'admin.api.admins.update','admin.api.admins.destroy','admin.api.admins.restore','admin.api.activities.index','admin.api.activities.admins',
'admin.api.activities.admin','admin.api.activities.users','admin.api.activities.user','admin.api.activities.show','admin.api.activities.clean',
'admin.api.users.index','admin.api.users.store','admin.api.users.show','admin.api.users.update','admin.api.users.destroy',
'admin.api.users.restore','admin.api.users.verify-email','admin.api.users.resend-verification','admin.api.users.login-as','admin.api.site-config.show',
'admin.api.site-config.update','public.api.csrf-cookie','public.api.register','public.api.login','public.api.password.request',
'public.api.password.reset','public.api.logout','public.api.me','public.api.verification.resend','public.api.profile.update',
'verification.verify','storage.local',);
        registerArgumentsSet('views', 
'admin','app','public','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'ADMIN_URL','USER_URL','ASSET_URL','APP_LOCALE','APP_FALLBACK_LOCALE',
...
'SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN','SESSION_SAME_SITE',
...
'ELASTICSEARCH_HOST','ELASTICSEARCH_PORT','MAIL_MAILER','MAIL_HOST','MAIL_PORT',
...
'VITE_APP_NAME','VITE_APP_URL','VITE_APP_DOMAIN','VITE_ADMIN_DOMAIN','VITE_PUBLIC_DOMAIN',
'SANCTUM_STATEFUL_DOMAINS','TEST_DOMAIN','TEST_PORT',);
