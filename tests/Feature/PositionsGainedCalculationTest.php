...
final class PositionsGainedCalculationTest extends TestCase
{
    ...
    public function test_driver_gains_positions(): void
    {
        ...
        RaceResult::create([
            ...
            'driver_id' => $driver1->id,
            'position' => null,
            'race_time' => '01:11:00.000', // Slowest - will qualify 3rd
            'fastest_lap' => '01:11:00.000',
            'dnf' => false,
            'status' => 'pending',
            'race_points' => 0,
        ...
        RaceResult::create([
            ...
            'driver_id' => $driver2->id,
            'position' => null,
            'race_time' => '01:09:00.000', // Fastest - will qualify 1st
        ...
        RaceResult::create([
            ...
            'position' => null,
            'race_time' => '01:10:00.000', // Middle - will qualify 2nd
            'fastest_lap' => '01:10:00.000',
            'dnf' => false,
            'status' => 'pending',
            'race_points' => 0,
